...
insert into tipo_documento(nombre, activo) values('SOBRE',1)
insert into tipo_documento(nombre, activo) values('PAQUETE',1)
insert into tipo_documento(nombre, activo) values('CAJA',1)
